...
- 加载容器并打开bash
    ...
    docker run --gpus all --name DL-torch-kaggle -p 12345:12345 -v /home/lemonmouse/share/:/workspace/share/ -it lemonmouse/torch-kaggle:miniconda37-cuda11.3.1-cudnn8-ubuntu20.04 /bin/bash
    ```